...
public class  ScaleTransformer implements DiscreteScrollItemTransformer {
    ...
    public static class Builder {
        ...
        private com.br.appanuncios.DiscreteScrollView.shop.transform.ScaleTransformer transformer;
        private float maxScale;

        public Builder() {
            transformer = new com.br.appanuncios.DiscreteScrollView.shop.transform.ScaleTransformer();
            maxScale = 1f;
        }
        ...
        public com.br.appanuncios.DiscreteScrollView.shop.transform.ScaleTransformer build() {
