...
public enum DSVOrientation {
    ...
    interface Helper {
        ...
        void offsetChildren(int amount, com.br.appanuncios.DiscreteScrollView.shop.RecyclerViewProxy lm);
    ...
    protected static class HorizontalHelper implements Helper {
        ...
        @Override
        public void offsetChildren(int amount, com.br.appanuncios.DiscreteScrollView.shop.RecyclerViewProxy helper) {
