...
import com.br.appanuncios.DiscreteScrollView.shop.transform.ScaleTransformer;
...
public class ShopActivity extends AppCompatActivity implements DiscreteScrollView.OnItemChangedListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        infiniteAdapter = InfiniteScrollAdapter.wrap(new com.br.appanuncios.DiscreteScrollView.shop.ShopAdapter(data));
