...
import com.br.appanuncios.helper.Permissoes;
...
public class CadastrarAnuncioActivity extends AppCompatActivity
    ...
    private EditText campoTitulo, campoDescricao,campoNomeLoja;
    ...
    private Anuncio configurarAnuncio(){
        ...
        String nomeLoja = campoNomeLoja.getText().toString();
                        ...
                        if( !valor.isEmpty() && !valor.equals("0") ){
                            if( !anuncio.getTelefone().isEmpty()  ){
                                if( !anuncio.getDescricao().isEmpty() ){
                                    if (!anuncio.getNomeLoja().isEmpty()) {

                                        salvarAnuncio();
                                    }else{
                                        exibirMensagemErro("Preencha o campo nome da loja");
                                    }
                                }else {
                                    exibirMensagemErro("Preencha o campo descriçao");
                                }
                            }else {
    ...
    private void inicializarComponentes(){
        campoNomeLoja = findViewById(R.id.editNomeLoja);
...
//
//        data.setText("Postado : "+formattedDate);
//        data.setGravity(Gravity.LEFT);
//        data.setTextSize(12);
//        data.setTextColor(getResources().getColor(R.color.Red));
//        setContentView(data);
