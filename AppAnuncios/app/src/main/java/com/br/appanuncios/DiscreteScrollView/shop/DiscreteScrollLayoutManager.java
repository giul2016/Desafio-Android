...
class DiscreteScrollLayoutManager extends RecyclerView.LayoutManager {
    ...
    private com.br.appanuncios.DiscreteScrollView.shop.DSVOrientation.Helper orientationHelper;
    ...
    private com.br.appanuncios.DiscreteScrollView.shop.RecyclerViewProxy recyclerViewProxy;

    public DiscreteScrollLayoutManager(
            @NonNull Context c,
            @NonNull ScrollStateListener scrollStateListener,
            @NonNull com.br.appanuncios.DiscreteScrollView.shop.DSVOrientation orientation) {
        this.context = c;
        ...
        this.recyclerViewProxy = new com.br.appanuncios.DiscreteScrollView.shop.RecyclerViewProxy(this);
    ...
    protected void setRecyclerViewProxy(com.br.appanuncios.DiscreteScrollView.shop.RecyclerViewProxy recyclerViewProxy) {
        this.recyclerViewProxy = recyclerViewProxy;
    }

    protected void setOrientationHelper(com.br.appanuncios.DiscreteScrollView.shop.DSVOrientation.Helper orientationHelper) {
