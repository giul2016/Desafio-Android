...
import com.br.appanuncios.DiscreteScrollView.shop.transform.DiscreteScrollItemTransformer;
...
public class DiscreteScrollView extends RecyclerView {
    ...
    public static final int NO_POSITION = com.br.appanuncios.DiscreteScrollView.shop.DiscreteScrollLayoutManager.NO_POSITION;

    private static final int DEFAULT_ORIENTATION = com.br.appanuncios.DiscreteScrollView.shop.DSVOrientation.HORIZONTAL.ordinal();

    private com.br.appanuncios.DiscreteScrollView.shop.DiscreteScrollLayoutManager layoutManager;
    ...
    private void init(AttributeSet attrs) {
        ...
        layoutManager = new com.br.appanuncios.DiscreteScrollView.shop.DiscreteScrollLayoutManager(
                getContext(), new ScrollStateListener(),
                com.br.appanuncios.DiscreteScrollView.shop.DSVOrientation.values()[orientation]);
        setLayoutManager(layoutManager);
    }

    @Override
    public void setLayoutManager(LayoutManager layout) {
        if (layout instanceof com.br.appanuncios.DiscreteScrollView.shop.DiscreteScrollLayoutManager) {
    ...
    public void setOrientation(com.br.appanuncios.DiscreteScrollView.shop.DSVOrientation orientation) {
    ...
    public void addScrollListener(@NonNull ScrollListener<?> scrollListener) {
        addScrollStateChangeListener((ScrollStateChangeListener<?>) new ScrollListenerAdapter((ScrollListener) scrollListener));
    }
    ...
    public void removeScrollListener(@NonNull ScrollListener<?> scrollListener) {
        removeScrollStateChangeListener((ScrollStateChangeListener<?>) new ScrollListenerAdapter<>((ScrollListener<ViewHolder>) scrollListener));
    }
    ...
    private class ScrollStateListener implements com.br.appanuncios.DiscreteScrollView.shop.DiscreteScrollLayoutManager.ScrollStateListener {
